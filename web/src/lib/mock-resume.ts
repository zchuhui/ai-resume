...
export const templateDemoResumes: Record<TemplateStyle, Resume> = {
  ...
  tech: defaultResume,
  chinesePro: createResume({
    basicInfo: {
      name: '庄楚辉',
      title: '全栈工程师',
      email: '943339564@gmail.com',
      phone: '13411183876',
      location: '深圳',
      website: '',
      github: '',
    ...
    summary:
      '13 年全栈研发经验，具备 0-1 独立交付能力。熟悉前后端主流技术栈，能独立完成从产品规划、需求分析、架构设计到开发、测试、部署的完整闭环；专注 AI 驱动研发，能把 Claude、Cursor、Codex 等工具嵌入真实交付流程。',
    experience: [
      {
        company: '深圳市领德创科技有限公司',
        position: '全栈工程师 · 数据组开发主管',
        startDate: '2023.06',
        endDate: '至今',
        location: '深圳',
        description: [
          '主导公司 BI 数字化系统建设，打通 EHR、金蝶云星空、盘古 MES 等多源异构数据，完成清洗、分析与预判输出',
          '搭建运营部门 AI 流程化体系，自动抓取、对比数据并输出方案，替代大量重复人力操作',
          '开发财务数据转换系统，对接各平台订单自动下载、清洗后同步至金蝶云星空 ERP',
        ],
      },
      {
        company: '深圳市易简空间技术有限公司',
        position: '技术主管',
        startDate: '2019.04',
        endDate: '2023.05',
        location: '深圳',
        description: [
          '主导多个项目技术选型与架构设计，搭建前后端一体化工程框架与通用组件库',
          '设计 Nginx + Jenkins 前端自动化部署流程，打通 CI/CD 全链路，实现一键部署与快速回滚',
          '负责开发周期规划与进度管理，主导前端性能优化并通过代码评审培养团队成员',
        ],
      },
      {
        ...
        location: '广州',
        description: [
          '深度参与核心产品开发规划，协同评估技术可行性，主导前端方案与迭代排期',
          '搭建多款后台管理系统前端工程框架，统一路由、状态管理与构建流程',
          '牵头制定前端编码规范，沉淀公共组件库与通用业务组件，提升效率与 UI 一致性',
        ],
      },
    ],
    education: [
      { school: '广州大学', degree: '本科', field: '计算机科学与技术', startDate: '2016', endDate: '2018' },
      { school: '广州大学市政技术学院', degree: '大专', field: '计算机科学与技术', startDate: '2010', endDate: '2013' },
    ],
    projects: [
      {
        name: 'ResumeCraft · AI 简历优化与生成工具',
        role: '独立全栈开发 · 个人项目',
        startDate: '2026.06',
        endDate: '至今',
        description: [
          '面向求职场景的 AI 简历优化工具，支持上传 PDF/Word 自动解析为结构化数据，结合目标岗位 JD 改写和 ATS 关键词匹配分析',
          '封装 OpenAI SDK 兼容的大模型调用层，通过 JSON 输出约束、Zod 校验、自愈重试提升 AI 结果稳定性',
          '基于 Puppeteer 实现可复制文本、ATS 可解析的矢量 PDF 导出，docx 生成 Word，保持预览和导出风格一致',
        ],
      },
      {
        name: 'AI 对话教练 · Dolfi',
        ...
        endDate: '至今',
        description: [
          '独立完成产品设计、UI、前后端到部署全链路，提供文字流式与实时语音双模态交互',
          '设计 ASR→LLM→TTS 全双工流式语音管线，支持随时打断与低延迟响应',
          '自研教练质量评估和重写机制，核心模块单测覆盖率 80%+',
        ],
      },
      {
        name: '领德创 BI 数据系统',
        ...
        endDate: '至今',
        description: [
          '面向管理层的一站式 BI 平台，对接金蝶 K3Cloud、领星 FBA、EHR 等多源数据，覆盖 10+ 业务域',
          '独立设计 HR 人力资源分析模块 10 个二级页面，落地 40+ 关键 HR 指标',
          '统一图表主题与可视化体系，封装中间件实现路由级鉴权下沉',
        ],
      },
    ],
    skills: [
    ...
    certifications: [
      { name: 'ICF 教练技术受训背景', issuer: '', date: '' },
      { name: '系统架构设计实战', issuer: '', date: '' },
    ],
    languages: [
      { language: '中文', proficiency: '母语' },
      { language: '英文', proficiency: '技术文档读写' },
    ],
  }),
