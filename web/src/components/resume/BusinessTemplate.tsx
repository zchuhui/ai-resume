...
export function BusinessTemplate({ resume, className }: BusinessTemplateProps) {
  const { basicInfo, summary, experience, education, projects, skills, certifications, languages } = resume
  const tokens = getTokens('business')
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 px-[5%] py-[4%] gap-[4%]">
        ...
        <div className="w-[62%] flex flex-col gap-[5%]" style={{ borderLeft: `1px solid ${colors.borderLight}`, paddingLeft: '4%' }}>
          {experience.length > 0 && (
            <section>
